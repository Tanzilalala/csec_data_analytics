...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        items = 20000
        # Extract CVE data
        cve_data = NvdApiUtility.extract_cve_data(api_key)
        ...
        if cve_data and 'vulnerabilities' in cve_data:
            ...
            for cve_item in vulnerabilities:
                ...
                Vulnerability.objects.create(
                    ...
                    cwes=[entry['cwe']['ID'] for entry in cve_item.get('cve', {}).get('problemtype', {}).get('problemtype_data', [])],
                    cisa_exploitability_metric=cve_item.get('impact', {}).get('cvss', {}).get('exploitabilityScore', None),
